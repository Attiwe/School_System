                            ...
                            <form action="{{route('fees.store')}}" method="POST"  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="number" name="amount" id="amount" class="form-control" value="{{ old('amount') }}" required autocomplete="off" numeric  required>
                                        @error('amount')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3">
                                        ...
                                        <textarea name="desc" id="desc"  class="form-control" required>{{ old('desc', '--') }}</textarea>
                                        @error('desc')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
