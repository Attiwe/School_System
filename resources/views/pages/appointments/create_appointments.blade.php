...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">صفحات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ فارغة</span>
        </div>
    </div>
</div>
@endsection
    ...
    <form method="POST" action="{{route('appointments.store')}} ">
        ...
        <div class="row">
             <div class="mb-3 col-md-6">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="أدخل اسمك">
                @error('name')
             ...
             <div class="mb-3 col-md-6">
                ...
                <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" placeholder="أدخل بريدك الإلكتروني">
                @error('email')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row">
             ...
             <div class="mb-3 col-md-6">
                <label for="Specialization_id">التخصص <span class="text-danger">*</span></label>
             ...
             <div class="mb-3 col-md-3">
                ...
                <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone') }}" placeholder="أدخل رقم الهاتف">
                @error('phone')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
         ...
         <div class="mb-3">
            ...
            <textarea class="form-control" id="address" name="address" placeholder="أدخل عنوانك" rows="4">{{ old('address') }}</textarea>
            @error('address')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
