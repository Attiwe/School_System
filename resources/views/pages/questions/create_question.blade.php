        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">
                    <h3> <i class="fa-solid fa-layer-group text-danger "> أسئلة </i></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12 mb-3">
                                            ...
                                            <textarea name="right_answer" id="right_answer"
                                                ...
                                                required>{{ old('right_answer') }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6 mb-3">
                                            ...
                                            <select id="quizze_id" name="quizze_id" class="form-control" required>
                                                <option value="" disabled selected>اختر اختبارًا</option>
                                        ...
                                        <div class="col-12 col-md-6 mb-3">
                                            ...
                                            <input type="number" name="score" id="score" class="form-control"
                                                value="{{ old('score') }}" required min="0">
                                            @error('score')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
