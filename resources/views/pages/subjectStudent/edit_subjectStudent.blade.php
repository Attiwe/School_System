    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">
                <h3> <i class="fa-solid fa-recycle text-primary ">    تعديل المواد الدراسيه </i></h3>
        ...
        <div class="card mt-5">
            <div class="col-xl-12">
                <div class="card-header pb-0">
                    <p class="tx-12 tx-gray-500 mb-2">تعديل المواد الدراسيه <a href="#">تعرف على المزيد</a></p>
                    <div class="card-body">
                        <div class="table-responsive">
                            <form action=" {{route('subjectStudent.update','test')}} " method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <input type="hidden" name="id" value="{{$subject->id}}">
                                    <div class="col-12 col-md-12 mb-3">
                                        <label for="nameSubject" class="form-label">اسم المواد الدراسيه</label>
                                        <input type="text" name="nameSubject" id="nameSubject" class="form-control"
                                            value="{{ old('nameSubject',$subject->nameSubject) }}" required autocomplete="off">
                                        @error('nameSubject')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-4 mb-3">
                                        ...
                                        <option value="{{$subject->class_id}}">{{$subject->class->nameClass }}</option>
                                        </select>
                                        @error('class_id')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
