                                ...
                                <div class="row">
                                    <div class="col-12 col-md-12 mb-3">
                                        ...
                                        <input type="text" name="nameQuizze" id="nameQuizze" class="form-control"
                                            value="{{ old('nameQuizze',$quizze->nameQuizze) }}" required autocomplete="off">
                                        @error('nameQuizze')
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <select id="grade_id" name="grade_id" class="form-control" required>
                                            <option value="{{$quizze->grade_id}}">{{$quizze->grade->name}}</option>
                                    ...
                                    <div class="col-12 col-md-3 mb-3">
                                        ...
                                        <option value="{{$quizze->class_id}}">{{$quizze->class->nameClass}}</option>
                                        </select>
                                        @error('class_id')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="col-12 col-md-3 mb-3">
                                        ...
                                        <option value="{{$quizze->section_id}}">{{$quizze->section->nameSectian}}</option>
                                    ...
                                    <div class="col-12 col-md-6  mb-3">
                                        ...
                                        <option value="{{$quizze->subject_id}}">{{$quizze->subject->nameSubject}}</option>
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <option value="{{$quizze->teacher_id}}">{{$quizze->teacher->name}}</option>
