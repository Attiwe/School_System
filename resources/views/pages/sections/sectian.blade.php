        ...
        @foreach ($Grades as $Grade)
            <div class="accordion-item">
                ...
                <div id="collapse-{{ $Grade->id }}" class="accordion-collapse collapse show"
                    aria-labelledby="heading-{{ $Grade->id }}" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover text-center table table-hover ">
                                <thead class="table-primary text-center">
                                    <tr class="font-weight-bold">
                                    <th class="py-3 fw-bold fs-6"><h5>#</h5></th>
                                        <th class="py-3 fw-bold fs-6"><h5>اسم الفصل</h5></th>
                                        <th class="py-3 fw-bold fs-6"><h5>المرحلة الدراسية</h5></th>
                                        <th class="py-3 fw-bold fs-6"><h5>الفصل الدراسي</h5></th>
                                        <th class="py-3 fw-bold fs-6"><h5>اسماء الدكاتره</h5></th>
                                        <th class="py-3 fw-bold fs-6"><h5>اسماء المعدين</h5></th>
                                        <th class="py-3 fw-bold fs-6"><h5>حالة الصف</h5></th>
                                        <th class="py-3 fw-bold fs-6"><h5>الوصف</h5></th>
                                        <th class="py-3 fw-bold fs-6"><h5>العمليات</h5></th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if ($section->appointments->isNotEmpty())
                                                @foreach ($section->appointments as $appointment)
                                                    <a href="{{ route('appointments.index') }}" class="text-danger">
                                                        {{ $appointment->name }}
                                                    </a>
                                                    {{ !$loop->last ? ' _and_ ' : '  ' }}
                                                @endforeach
                                            ...
                                            <td>{{ $section->desc ? $section->desc : '--' }}</td>
                                            <td>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('section.destroy', $section->id) }}"
                                                            ...
                                                            <input type="hidden" name="id" value="{{ $section->id }}">
                                                             ...
                                                             <input class="form-control" type="text" name="nameSection"
                                                                value="{{ $section->nameSectian }}" readonly>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">تعديل الفصل</h5>
                        ...
                        <form action="{{ route('section.update' ) }}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nameSectian" class="form-control"
                                        value="{{ old('nameSectian', $section->nameSectian) }}" required>
                                    @error('nameSectian')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="statuse" class="form-select" required>
                                        <option value="1" {{ $section->statuse == 1 ? 'selected' : '' }}>نشط</option>
                                        <option value="0" {{ $section->statuse == 0 ? 'selected' : '' }}>غير نشط</option>
                                    </select>
                                </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="class_id" id="class_id" class="form-select" required>
                                <option value="{{$section->id}}" selected  >{{$section->classRom->nameClass}} </option>
                            </select>
                            @error('class_id')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="appointment_id" class="control-label">القائمة الثانية</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="desc" rows="5" class="form-control" id="desc" placeholder="أضف ملاحظات">{{ old('desc', $section->desc ?? '') }}</textarea>
                                </div>
                            </div>
                            <div class="modal-footer">
