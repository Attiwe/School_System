...
@section('page-header')
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h2><i class="fa-solid fa-book-open text-primary"> تعديل كتاب </i></h2>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 mb-3">
                                ...
                                <input type="text" id="nameBook" name="nameBook" class="form-control"
                                    value="{{ old('nameBook', $library->nameBook) }}" required autocomplete="off">
                                @error('nameBook')
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <select id="grade_id" name="grade_id" class="form-control" required>
                                    <option value="{{ $library->grade_id }}">{{ $library->grade->name }}</option>
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <select name="class_id" id="class_id" class="form-control" required>
                                    <option value="{{ $library->class_id }}">{{ $library->class->nameClass }}</option>
                                </select>
                                @error('class_id')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <select id="section_id" name="section_id" class="form-control" required>
                                    <option value="{{ $library->section_id }}">{{ $library->section->nameSectian }}</option>
                                </select>
                                @error('section_id')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <!-- <div class="  mt-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" id="file_name" class="form-control" name="file_name[]"
                                        value="{{ $library->file_name }}" multiple multiple accept="application/pdf" readonly>
                                </div>
                            </div> -->
                ...
                if (grade_id) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            classSelect.empty().append('<option value="" selected disabled>-- اختر الصف --</option>');
                ...
                if (class_id) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            sectionSelect.empty().append('<option value="" selected disabled>-- اختر القسم --</option>');
                            $.each(data, function (key, value) {
